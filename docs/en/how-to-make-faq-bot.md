...
* [Introduction](#introduction)
  ...
  + [What is the solution? 🙋‍♂️](#What-is-the-solution?-------)
...
When we save it, Facebook will send `GET` request which contains the verification process 
to make sure webhook requirements are met.
